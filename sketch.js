...
player = createSprite(displayWidth-1150, displayHeight-300, 50, 50);
 player.addImage(shooterImg)
   ...
   heart1.visible = false
    ...
    //reset=createSprite(displayWidth-400,50,10,10);
...
text("IF YOU WANT TO WIN THEN COLLECT 100 COIN !",displayWidth-1100,displayHeight/2-500);
...
//destroy zombie, player and bullets and display a message in gameState "bullet"
  ...
  textSize(50)
  fill("yellow")
  text("You ran out of bullets!!!",500,410)
  zombieGroup.destroyEach();
  player.destroy();
  bulletGroup.destroyEach();
